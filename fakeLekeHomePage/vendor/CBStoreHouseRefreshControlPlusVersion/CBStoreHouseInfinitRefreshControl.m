...
{
    return [CBStoreHouseInfinitRefreshControl attachToScrollView:scrollView
                                                   target:target
...
{
    CBStoreHouseInfinitRefreshControl *refreshControl = [[CBStoreHouseInfinitRefreshControl alloc] init];
    ...
    refreshControl.sHeight = [UIScreen mainScreen].bounds.size.height;
...
{
    return _scrollView.contentSize.height - _scrollView.contentOffset.y - _scrollView.frame.size.height;
}
